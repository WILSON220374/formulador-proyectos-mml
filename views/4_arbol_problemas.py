...
def render_card(seccion, item, idx):
    ...
    color = {
        "Efectos Indirectos": "#884EA0",
        "Efectos Directos": "#2E86C1",
        "Problema Principal": "#A93226",
        "Causas Directas": "#D4AC0D",
        "Causas Indirectas": "#CA6F1E"
    }.get(seccion, "#ccc")
...
with st.sidebar:
    ...
    tipo_sel = st.selectbox(
        "Nivel:",
        ["Efectos Indirectos", "Efectos Directos", "Problema Principal", "Causas Directas", "Causas Indirectas"],
        index=2
    )
        ...
        def mostrar_seccion_dinamica(tipo_padre, tipo_hijo):
            ...
            if "Efecto" in tipo_padre:
                ...
                for i, p_data in enumerate(padres):
                    with cols_p[i]:
                        render_card(tipo_padre, p_data, i)
