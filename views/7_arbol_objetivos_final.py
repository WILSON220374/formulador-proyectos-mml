...
with st.sidebar:
    ...
    def generar_arbol_graphviz():
        ...
        # --- NUEVO: TÍTULO DENTRO DEL GRÁFICO ---
        # labelloc='t' coloca el texto en la parte superior (top)
        dot.attr(label='\nÁRBOL DE OBJETIVOS FINAL\n ', labelloc='t', 
                 fontsize='24', fontname='Arial Bold', fontcolor='#1E3A8A')
        
        dot.attr(rankdir='TB', nodesep='0.6', ranksep='0.8', splines='ortho')
...
# --- RENDERIZADO DE EDICIÓN (TARJETAS) ---
...
# (Se mantienen tus funciones mostrar_seccion y mostrar_rama aquí abajo)
